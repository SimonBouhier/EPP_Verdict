...
product. [Current status](/current-status/) identifies implemented and
...
[ADR-021](/adrs/adr-021-github-governance/) defines this boundary.
...
[ADR-022](/adrs/adr-022-post-blockchain-refocus/) records retirement of
...
- [Current status and verification snapshot](/current-status/)
- [Code map](/architecture/)
- [ADR-021: GitHub governance](/adrs/adr-021-github-governance/)
- [ADR-022: post-blockchain scope](/adrs/adr-022-post-blockchain-refocus/)
- [Historical narrative and source references](/history/)
