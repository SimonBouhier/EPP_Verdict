...
| Formal verification | Lean 4 — **6 substantive theorems** (tier `iff` + cumulativity) + 7 regression tests + 2 type-level invariants | `Formal/` (ADR-020 + [`docs/audit/`](https://github.com/SimonBouhier/EPP_Verdict/tree/main/docs/audit/)) |
