# EPP — a reviewable record of model deliberation
...
Their [current status and dated checks](docs/CURRENT_STATUS.md) describe the
...
[historical pitch](docs/history/2026-09-05/PITCH.md).

Read the [whitepaper](WHITEPAPER.md) for the present design and its limits.
