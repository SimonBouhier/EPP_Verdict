...
class TestStoreGetConceptEmbedding:
    ...
    def test_store_concept_embedding(self, tmp_path):
    ...
    def test_get_concept_embedding(self, tmp_path):
...
class TestConceptsNeedingMigration:
    ...
    def test_concepts_needing_migration(self, tmp_path):
    ...
    def test_concepts_needing_migration_with_limit(self, tmp_path):
...
class TestMigrationEntry:
    ...
    def test_create_embedding_migration(self, tmp_path):
    ...
    def test_update_embedding_migration(self, tmp_path):
    ...
    def test_migration_logging(self, tmp_path):
...
class TestFinalizeMigration:
    ...
    def test_finalize_copies_to_concepts(self, tmp_path):
    ...
    def test_finalize_refuses_if_failures(self, tmp_path):
...
class TestRollbackMigration:
    ...
    def test_rollback_deletes_embeddings(self, tmp_path):
