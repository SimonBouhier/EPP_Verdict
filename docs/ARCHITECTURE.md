...
[preserved here](history/2026-09-05/ARCHITECTURE.md).
...
The [verification snapshot](CURRENT_STATUS.md#verification-snapshot) states
...
See [publishing and maintenance](PUBLISHING.md).
